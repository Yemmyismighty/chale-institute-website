...
export const metadata: Metadata = {
  title: programsContent.metadata.title,
  description: programsContent.metadata.description,
  keywords: programsContent.metadata.keywords,
  openGraph: {
    title: programsContent.metadata.title,
    description: programsContent.metadata.description,
    images: [programsContent.metadata.ogImage || '/images/og-image.jpg'],
  },
};

export default function Programs() {
  const { hero, sections } = programsContent;
