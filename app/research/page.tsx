...
export const metadata: Metadata = {
  title: researchContent.metadata.title,
  description: researchContent.metadata.description,
  keywords: researchContent.metadata.keywords,
  openGraph: {
    title: researchContent.metadata.title,
    description: researchContent.metadata.description,
    images: [researchContent.metadata.ogImage || '/images/og-image.jpg'],
  },
};

export default function Research() {
  const { hero, sections } = researchContent;
