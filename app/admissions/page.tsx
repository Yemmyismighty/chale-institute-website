...
export const metadata: Metadata = {
  title: admissionsContent.metadata.title,
  description: admissionsContent.metadata.description,
  keywords: admissionsContent.metadata.keywords,
  openGraph: {
    title: admissionsContent.metadata.title,
    description: admissionsContent.metadata.description,
    images: [admissionsContent.metadata.ogImage || '/images/og-image.jpg'],
  },
};

export default function Admissions() {
  const { hero, sections } = admissionsContent;
